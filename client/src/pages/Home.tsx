      ...
      <main className="container mx-auto px-4 py-8">
        <header className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
          <div>
            <h1 className="text-4xl md:text-5xl font-display font-bold mb-2">
              Production <span className="text-primary text-glow">Dashboard</span>
            </h1>
            <p className="text-muted-foreground text-lg max-w-2xl">
              Monitor active cheese batches, track fermentation stages, and ensure quality control.
            </p>
          </div>
        ...
        {isLoading ? (
          ...
          <div className="text-center py-20 border border-dashed border-border rounded-3xl bg-secondary/5">
            ...
            <h3 className="text-xl font-bold mb-2">No Active Batches</h3>
            <p className="text-muted-foreground mb-8">Start a new production run to begin tracking.</p>
            <Link href="/new">
              <Button>Start First Batch</Button>
            </Link>
          </div>
        ) : (
                ...
                <div className="h-full glass-card p-6 rounded-2xl hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 relative overflow-hidden">
                  ...
                  <div className="relative z-10">
                    ...
                    <div className="text-sm text-muted-foreground mb-6">
                      Vol: <span className="text-foreground font-medium">{batch.milkVolumeL}L</span> • Started {new Date(batch.startedAt).toLocaleDateString()}
                    </div>
